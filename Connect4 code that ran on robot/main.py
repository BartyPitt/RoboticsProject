...
PandaRobot.AddPosition("1" ,              [0.624, 0.347, 0.75, pi,0,pi/4]) # Not the right numbers
PandaRobot.AddPosition("2" ,              [0.6, 0.269, 0.8, pi, 0, pi/4]) # Not the right numbers
PandaRobot.AddPosition("3" ,              [0.6, 0.191, 0.8, pi, 0, pi/4]) # Not the right numbers
PandaRobot.AddPosition("4" ,              [0.6, 0.113, 0.8, pi, 0, pi/4]) # Not the right numbers
PandaRobot.AddPosition("5" ,              [0.6, 0.035, 0.8, pi, 0, pi/4]) # Not the right numbers
PandaRobot.AddPosition("6" ,              [0.6, -0.043, 0.8, pi, 0, pi/4]) # Not the right numbers
PandaRobot.AddPosition("7" ,              [0.624, -0.118, 0.75, pi,0,pi/4]) # Not the right numbers

# Calibration positions
PandaRobot.closegrip()
PandaRobot.moveto(0.624, 0.347, 0.65, pi,0,pi/4)
#sleep(5)
state = int(input("now calibrate first postion"))
PandaRobot.moveto(0.624, -0.118, 0.65, pi,0,pi/4)
state = int(input("now calibrate second postion"))
#sleep(5)


# PandaRobot.MoveToPosition("1")
# print("done position 1")
# PandaRobot.MoveToPosition("2")
# print("done position 2")

# PandaRobot.MoveToPosition("3")
# print("done position 3")

# PandaRobot.MoveToPosition("4")
# print("done position 4")

# PandaRobot.MoveToPosition("5")
# print("done position 5")

# PandaRobot.MoveToPosition("6")
# print("done position 6")

# PandaRobot.MoveToPosition("7")
# print("done position 7")
