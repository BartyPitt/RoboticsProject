...
if("FALSE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /home/user/catkin_ws/src/franka_ros/franka_description_ORIGINAL)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/install/${idir}'.  ${_report}")
    endif()
